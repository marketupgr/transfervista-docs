...
| **Stripe Secret Key** | Your Stripe secret key (starts with `sk_`). Keep this confidential. Found in your Stripe Dashboard under Developers > API keys. |
...
4. Paste both keys into the corresponding fields in TransferVista
