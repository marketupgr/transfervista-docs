...
- Upload your logo and set brand colors in [**Settings > Branding**](/docs/en/settings/branding)
- Add your Terms of Service and Privacy Policy URLs in [**Settings > General**](/docs/en/settings/general)
...
- Set up [availability rules](/docs/en/availability/rules-scheduling) for business hours
- Set up [areas](/docs/en/catalog/areas) and create price entries by route for popular routes
- Enable/disable [email communication notifications](/docs/en/communications/email-templates)
- Add [extra services](/docs/en/catalog/extras) like meet-and-greet, child seats, etc.

### Invite Your Team

- Add team members and drivers in [**Team > Members**](/docs/en/team/members)
- Configure driver permissions in [**Settings > Permissions**](/docs/en/settings/permissions)

### Manage Your First Real Booking

When a customer makes a booking, you'll receive an email notification. Learn more about:

- [Viewing and managing bookings](/docs/en/bookings/overview)
- [Assigning drivers to transfers](/docs/en/bookings/assigning-operators)
- [Understanding the booking status workflow](/docs/en/bookings/status-workflow)
